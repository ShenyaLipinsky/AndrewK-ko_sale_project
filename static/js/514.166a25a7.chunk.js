...
`;var Z=i(5369);const X=e=>{let{disF:t,disB:i,setPage:r,page:o,totalHist:a,setLimit:n}=e;return(0,F.jsxs)(K,{children:[(0,F.jsx)(G,{type:"button",disabled:i,onClick:()=>{let e=parseInt(o)-1;r(e.toString())},children:(0,F.jsx)(Z.Tsg,{})}),(0,F.jsxs)(Y,{className:"qtyOnPage",defaultValue:"10",onChange:e=>{n(e.target.value),a<=parseInt(e.target.value)&&r("1")},children:[(0,F.jsx)("option",{value:"5",children:"5"}),(0,F.jsx)("option",{value:"10",children:"10"}),(0,F.jsx)("option",{value:"15",children:"15"})]}),(0,F.jsx)(G,{type:"button",disabled:t,onClick:()=>{let e=parseInt(o)+1;r(e.toString())},children:(0,F.jsx)(Z.eW4,{})})]})},ee=(0,M.Ay)(Q.m)`
  display: grid;
  position: relative;
...
`}}]);
//# sourceMappingURL=514.166a25a7.chunk.js.map